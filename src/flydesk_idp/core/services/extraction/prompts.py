...
:mod:`flydesk_idp.resources.prompts`. At boot the catalog uses
...
class PromptCatalog:
    ...
    ...) for the LLM stages that ship with flydesk-idp. For ad-hoc
...
def _resources_dir() -> Path:
    ...
    return Path(str(resources.files("flydesk_idp.resources.prompts")))
