...
dependency (``pip install flydesk-idp[docling]``). The import is lazy
...
class DoclingOcrEngine:
    ...
    def recognise(
        ...
        *,
        ...
        source = document_stream_cls(name=f"flydesk-idp-input{ext}", stream=io.BytesIO(data))
    ...
    def _get_converter(self) -> Any:
        ...
        try:
            ...
            raise RuntimeError(
                ...
                "(``pip install flydesk-idp[docling]``) to enable "
